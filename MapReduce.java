...
public class MapReduce {
    ...
    public static class Map extends Mapper<LongWritable, Text, IntWritable, Text>{
         ...
         * 1.每次读取一条要分类的条记录与中心做对比，归类到对应的中心
         ...
         protected void map(LongWritable key, Text value, Context context)
            ...
            for(int i=0;i<k;i++){
             ...
             String fs = value.toString();
           //  System.out.println(fs+centerIndex);
         }
     ...
     public static class Reduce extends Reducer<IntWritable, Text, Text, Text>{
         ...
         protected void reduce(IntWritable key, Iterable<Text> value,Context context)
             ...
             for(Iterator<Text> it =value.iterator();it.hasNext();){
                 ...
                 //System.out.println(Utils.textToArray(it.next()));
     ...
     public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
         String centerPath = "hdfs://localhost:9000/user/kylin/input/centers.txt";
         String dataPath = "hdfs://localhost:9000/user/kylin/input/wine.txt";
         String newCenterPath = "hdfs://localhost:9000/user/kylin/out/kmean";
         String countPath = "hdfs://localhost:9000/user/kylin/out/kmean2";
         ...
         Count.run(newCenterPath, countPath);
     }
